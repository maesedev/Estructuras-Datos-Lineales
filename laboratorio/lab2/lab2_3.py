...
productos en la lista. Implementar una función (método) recursivo."""
    ...
    promedio = round(suma_precios / lista.size()) 
    print(f"El precio medio de todos los  productos es: ${promedio}")
